...
class Config:
    ...
    @classmethod
    def set_sample(cls, species, cancer_type, sample_id):
        """设置样本信息并更新所有路径"""
        cls.species = species
        cls.cancer_type = cancer_type
        cls.id = sample_id
        cls.update_paths()
    ...
    def update_paths(cls):
        """更新所有路径变量"""
        cls.file_dir = os.path.join(cls.file_root, cls.species, cls.cancer_type, cls.id)
        cls.input_json_path = os.path.join(cls.file_dir, "spot_domain_features.json")
        cls.output_dir = os.path.join(cls.file_dir, "tumor_analysis_results")
...
def main():
    """主程序 - 进行批量分析"""
    sample_list = [
        {"species": "Homo sapiens", "cancer_type": "COAD", "sample_id": "TENX89"},
        {"species": "Homo sapiens", "cancer_type": "COAD", "sample_id": "TENX90"},
        {"species": "Homo sapiens", "cancer_type": "COAD", "sample_id": "TENX91"},
        {"species": "Homo sapiens", "cancer_type": "COAD", "sample_id": "TENX92"},

        {"species": "Homo sapiens", "cancer_type": "EPM", "sample_id": "NCBI629"},
        {"species": "Homo sapiens", "cancer_type": "EPM", "sample_id": "NCBI630"},
        {"species": "Homo sapiens", "cancer_type": "EPM", "sample_id": "NCBI631"},
        {"species": "Homo sapiens", "cancer_type": "EPM", "sample_id": "NCBI632"},
        {"species": "Homo sapiens", "cancer_type": "EPM", "sample_id": "NCBI633"},

        {"species": "Homo sapiens", "cancer_type": "IDC", "sample_id": "NCBI681"},
        {"species": "Homo sapiens", "cancer_type": "IDC", "sample_id": "NCBI682"},
        {"species": "Homo sapiens", "cancer_type": "IDC", "sample_id": "NCBI683"},
        {"species": "Homo sapiens", "cancer_type": "IDC", "sample_id": "NCBI684"},
        {"species": "Homo sapiens", "cancer_type": "IDC", "sample_id": "TENX13"},
        {"species": "Homo sapiens", "cancer_type": "IDC", "sample_id": "TENX14"},

        {"species": "Homo sapiens", "cancer_type": "PAAD", "sample_id": "NCBI569"},
        {"species": "Homo sapiens", "cancer_type": "PAAD", "sample_id": "NCBI570"},
        {"species": "Homo sapiens", "cancer_type": "PAAD", "sample_id": "NCBI571"},
        {"species": "Homo sapiens", "cancer_type": "PAAD", "sample_id": "NCBI572"},

        {"species": "Homo sapiens", "cancer_type": "PRAD", "sample_id": "INT25"},
        {"species": "Homo sapiens", "cancer_type": "PRAD", "sample_id": "INT26"},
        {"species": "Homo sapiens", "cancer_type": "PRAD", "sample_id": "INT27"},
        {"species": "Homo sapiens", "cancer_type": "PRAD", "sample_id": "INT28"},
        {"species": "Homo sapiens", "cancer_type": "PRAD", "sample_id": "TENX40"},
        {"species": "Homo sapiens", "cancer_type": "PRAD", "sample_id": "TENX46"},

        {"species": "Homo sapiens", "cancer_type": "READ", "sample_id": "ZEN36"},
        {"species": "Homo sapiens", "cancer_type": "READ", "sample_id": "ZEN40"},
        {"species": "Homo sapiens", "cancer_type": "READ", "sample_id": "ZEN48"},
        {"species": "Homo sapiens", "cancer_type": "READ", "sample_id": "ZEN49"},
    ]
    ...
    for sample in sample_list:
        try:
            print(f"\n{'=' * 60}")
            print(f"开始分析: {sample['cancer_type']} - {sample['sample_id']}")
            print(f"{'=' * 60}")

            # 设置样本信息
            Config.set_sample(
                sample.get("species", "Homo sapiens"),
                sample["cancer_type"],
                sample["sample_id"]
            )
            ...
            print(f"分析失败: {sample['cancer_type']} - {sample['sample_id']}, 错误: {str(e)}")
            results.append({
    ...
    for result in results:
        print(f"{result['cancer_type']} - {result['sample_id']}: {result['num_clusters']}个聚类 ({result['status']})")
